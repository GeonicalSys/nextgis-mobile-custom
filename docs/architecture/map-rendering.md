...
17. Выбор слоя для нового объекта немедленно создаёт точку либо первый узел
    ...
    эту кнопку. Отмена нового скетча крестиком сразу возвращает обычную карту.
    ...
    заливку и индексы вершин после восстановления WKT-черновика. Площадь,
    измеренная линейкой, выводится в гектарах.
