...
Проверяемый выпуск `3.1.2.16`: production `versionCode 210`, Lisa Debug —
`3.1.2.11` / `versionCode 205`; диагностический release
`maplib.VERSION_NAME 3.1.2.16`, debug — `3.1.2.11`.
