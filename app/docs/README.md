...
- карта показывает свежую позицию GPS/Network с кругом точности в метрах и
  сектором направления телефона (истинный курс, без коррекции выноса); компас
  слушается только пока карта в foreground. Поддерживает approximate permission
