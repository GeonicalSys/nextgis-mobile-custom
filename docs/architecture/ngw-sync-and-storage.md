...
прервать её и ждёт закрытия всех lease перед продолжением. Периодический adapter
...
`ProjectOperationCoordinator.isDataSyncActive()` и останавливает устаревший
spinner только после фактического завершения адаптера и освобождения lease.
