...
17. Выбор слоя для нового объекта немедленно создаёт точку либо первый узел
    LineString/Polygon и их Multi-вариантов в центре карты, без промежуточной
    кнопки `+`. Следующие тапы вставляют узел после выбранного; на рёбрах линий,
    ...
    заливку и индексы вершин после восстановления WKT-черновика.
