...
- новый скетч начинается сразу после выбора слоя: точка или первый узел линии/
  полигона ставится в центр, следующие узлы добавляются тапами; midpoint-вставка
  работает для линий, полигонов и линейки, дополнения касанием/overflow нет;
