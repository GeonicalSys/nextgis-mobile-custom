...
| targetSdk | `36` |
| minSdk | `26` |
| App versionCode (release) | `214` |
| App versionName (release) | `3.1.2.20` |
| App versionCode (debug) | `215` |
| App versionName (debug) | `3.1.2.20` |
| maplib VERSION_NAME (release) | `3.1.2.20` |
| maplib VERSION_NAME (debug) | `3.1.2.20` |
