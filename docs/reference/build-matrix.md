...
| targetSdk | `36` |
| minSdk | `26` |
| App versionCode (release) | `209` |
| App versionName (release) | `3.1.2.15` |
| App versionCode (debug) | `204` |
| App versionName (debug) | `3.1.2.10` |
| maplib VERSION_NAME (release) | `3.1.2.15` |
| maplib VERSION_NAME (debug) | `3.1.2.10` |
