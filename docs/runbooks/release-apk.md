...
Проверяемый выпуск `3.1.2.15`: production `versionCode 209`, Lisa Debug —
`3.1.2.10` / `versionCode 204`; диагностический release
`maplib.VERSION_NAME 3.1.2.15`, debug — `3.1.2.10`.
