...
- Кнопка измерения азимута получила белую векторную розу ветров. К расчётному
  WMM2025-склонению добавлена сохраняемая коррекция `stakeout_declination_correction`:
  её можно менять в виджете во время измерения, она переживает перезапуск и
