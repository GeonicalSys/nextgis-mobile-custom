...
| targetSdk | `36` |
| minSdk | `26` |
| App versionCode (release) | `213` |
| App versionName (release) | `3.1.2.19` |
| App versionCode (debug) | `214` |
| App versionName (debug) | `3.1.2.19` |
| maplib VERSION_NAME (release) | `3.1.2.19` |
| maplib VERSION_NAME (debug) | `3.1.2.19` |
