...
- История скетча расширена с 10 до 100 отмен; одинаковые снимки от выбора узла и
  повторных MapLibre callbacks больше не занимают шаги, а Undo/Redo меняет одну
  реальную правку за одно нажатие без пустого шага на границе или переполнении.
