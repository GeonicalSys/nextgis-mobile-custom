...
| Raster MBTiles и перенос старых Debug-подложек в Geonical | [map-rendering.md](../architecture/map-rendering.md), [shared-underlays.md](../architecture/shared-underlays.md), [flavors-and-versioning.md](flavors-and-versioning.md) | `MbTilesInfo`, `LocalRasterTileServer`, `LegacyUnderlayProvider`, `LegacyUnderlayImporter` |
