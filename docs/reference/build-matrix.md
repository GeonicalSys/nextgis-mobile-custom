...
| targetSdk | `36` |
| minSdk | `26` |
| App versionCode (release) | `210` |
| App versionName (release) | `3.1.2.16` |
| App versionCode (debug) | `205` |
| App versionName (debug) | `3.1.2.11` |
| maplib VERSION_NAME (release) | `3.1.2.16` |
| maplib VERSION_NAME (debug) | `3.1.2.11` |
