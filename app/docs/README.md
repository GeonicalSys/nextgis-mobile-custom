...
- карта показывает свежую позицию GPS (чип или mock) с кругом точности в метрах и
  ...
  возврата к координате выключения экрана. Трек и обход сохраняют GNSS чипа или mock приёмника;
  чип сглаживается с учётом остановок, пешеходов и автомобилей до 160 км/ч, mock — как есть, не грубее 2 с / 1 м.
