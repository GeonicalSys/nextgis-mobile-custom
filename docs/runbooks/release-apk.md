...
Проверяемый выпуск `3.1.2.21`: production `versionCode 215`, Lisa Debug —
`3.1.2.21` / `versionCode 216`; диагностический release
`maplib.VERSION_NAME 3.1.2.21`, debug — `3.1.2.21`.
