...
- в новом скетче точки, линии и полигона кнопка формы активна после появления
  геометрии и проходит тот же путь проверки/сохранения, что верхняя кнопка
  «Сохранить»; повторное нажатие не открывает вторую форму;
