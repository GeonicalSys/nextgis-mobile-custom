...
- У курсора GPS поверх круга точности рисуется геодезический сектор направления
  ...
  выноса), ширина — оценка точности rotation vector, длина 32–80 м. Нет компаса
  или устаревший heading скрывают только сектор. Иконка stand/go не меняется.
  App PR закрепляет maplib `599243b` (Draft PR #24) до Merge Commit библиотеки.
