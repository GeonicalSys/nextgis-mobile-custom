...
- вращение карты двумя пальцами только после явного разрешения кнопкой рядом с
  ...
  ниже `7.1`. Кнопка местоположения также возвращает север, поднимает zoom до
  ...
  локальные MBTiles подложки по умолчанию делают точный белый прозрачным и
  растягивают только последний масштаб пирамиды (Настройки → Карта);
