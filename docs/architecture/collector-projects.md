...
- Общий process-wide coordinator удерживает active project identity на всё время
  ...
  и может корректно прервать sync; действие продолжается только после освобождения
  lease. Во время fill/rebuild сохраняется модальное ожидание; повторная полная
